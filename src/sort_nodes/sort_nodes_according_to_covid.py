		...
		if(code > 53):
			...
			if(code not in sorted_covid_cases_by_cities):
				...
				if(code in codes):
					...
					file_cities.write(str(code) + ';' + str(ln[4].split('/')[0]) + ';' + str(ln[3]) + ';' + str((date_now-first_date).days) + ';' + str(ln[1]) + '\n')
			...
			if(int(code_state) not in sorted_covid_cases_by_states):
				...
				file_states.write(str( int(code_state) ) + ';' + str(ln[4].split('/')[0]) + ';' + str(ln[3]) + ';' + str((date_now-first_date).days) + ';' + str(ln[1]) + '\n')
