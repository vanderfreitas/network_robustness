...
for thresh in [0, avg, avg+std]:
	...
	# Save data to disk
	file = open(relative_path + 'robustness_attack_sorted_covid_flow_sum_F_' + str(thresh) + '.csv', 'w')
	...
	file_out = open(relative_path + 'robustness_attack_sorted_covid_flow_sum_F_R_V_' + str(thresh) + '.csv', 'w')
