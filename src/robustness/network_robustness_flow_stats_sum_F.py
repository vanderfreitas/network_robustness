...
for thresh in [0, avg, avg+std]:
	...
	for stat in stats:
		...
		# Save data to disk
		file = open(relative_path + 'robustness_flow_attack_sum_F_' + stat + '_' + str(thresh) + '.csv', 'w')
		...
		file_out = open(relative_path + 'robustness_flow_attack_sum_F_' + stat + '_R_V_' + str(thresh) + '.csv', 'w')
